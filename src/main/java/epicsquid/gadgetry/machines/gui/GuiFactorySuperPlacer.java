...
import epicsquid.gadgetry.machines.tile.TileSuperPlacer;
...
public class GuiFactorySuperPlacer implements IGuiFactory {
  ...
  public Gui constructGui(EntityPlayer player, TileEntity tile) {
    ...
    return new GuiModular(new ContainerModular(t).tryAddSlot(0, 31, 23).tryAddSlot(1, 49, 23).tryAddSlot(2, 31, 41).tryAddSlot(3, 49, 41).tryAddSlot(4, 76, 14)
        ...
        .addElement(new ElementEnergyBar(8, 10, (ModuleEnergy) ((TileSuperPlacer) t).modules.get(TileSuperPlacer.BATTERY)))
        .addElement(new ElementToggleIOButton(135, 60, (TileModular) t, ((TileSuperPlacer) t).INVENTORY))
        .addElement(new ElementToggleIOButton(152, 60, (TileModular) t, ((TileSuperPlacer) t).BATTERY));
  }

  @Override
  public String getName() {
    return TileBase.getTileName(TileSuperPlacer.class);
  }
