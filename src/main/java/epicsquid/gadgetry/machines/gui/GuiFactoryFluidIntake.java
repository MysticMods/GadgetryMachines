...
import epicsquid.gadgetry.machines.tile.TileFluidIntake;
...
public class GuiFactoryFluidIntake implements IGuiFactory {
  ...
  public Gui constructGui(EntityPlayer player, TileEntity tile) {
    ...
    return new GuiModular(new ContainerModular(t).tryAddSlot(0, 80, 42).initPlayerInventory(player.inventory, 0, 0), 176, 166)
        .addElement(new ElementFluidTank(80, 10, ((ModuleFluid) ((TileFluidIntake) t).modules.get(TileFluidIntake.TANK)).manager.getTankProperties()[0]))
        .addElement(new ElementToggleIOButton(152, 60, (TileModular) t, ((TileFluidIntake) t).TANK));
  }

  @Override
  public String getName() {
    return TileBase.getTileName(TileFluidIntake.class);
  }
