...
import epicsquid.gadgetry.machines.tile.TileBreaker;
...
public class GuiFactoryBreaker implements IGuiFactory {
  ...
  public Gui constructGui(EntityPlayer player, TileEntity tile) {
    ...
    return new GuiModular(new ContainerModular(t).tryAddSlot(0, 62, 14).tryAddSlot(1, 80, 14).tryAddSlot(2, 98, 14).tryAddSlot(3, 62, 32).tryAddSlot(4, 80, 32)
        ...
        .addElement(new ElementToggleIOButton(152, 60, (TileModular) t, ((TileBreaker) t).INVENTORY));
  }

  @Override
  public String getName() {
    return TileBase.getTileName(TileBreaker.class);
  }
