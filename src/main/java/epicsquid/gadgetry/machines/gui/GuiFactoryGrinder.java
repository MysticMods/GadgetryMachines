...
public class GuiFactoryGrinder implements IGuiFactory {
  ...
  public Gui constructGui(EntityPlayer player, TileEntity tile) {
    ...
    return new GuiModular(new ContainerModular(t).tryAddSlot(0, 41, 34).tryAddSlot(1, 113, 34, true).initPlayerInventory(player.inventory, 0, 0), 176, 166)
        .addElement(new ElementHorizontalProgressBar(61, 34, 0, 16, 44, 16, 0, 0, ((TileGrinder) t).progress,
            new ResourceLocation(GadgetryMachines.MODID, "textures/gui/progress_bars.png")))
        .addElement(new ElementEnergyBar(10, 10, (ModuleEnergy) ((TileGrinder) t).modules.get(TileGrinder.BATTERY)))
        .addElement(new ElementToggleIOButton(152, 60, (TileModular) t, ((TileGrinder) t).BATTERY))
        .addElement(new ElementToggleIOButton(135, 60, (TileModular) t, ((TileGrinder) t).INVENTORY));
  }
