...
import epicsquid.gadgetry.machines.tile.TileEnergyCell;
...
public class GuiFactoryEnergyCell implements IGuiFactory {
  ...
  public Gui constructGui(EntityPlayer player, TileEntity tile) {
    ...
    return new GuiModular(new ContainerModular(t).tryAddSlot(0, 80, 42).initPlayerInventory(player.inventory, 0, 0), 176, 166)
        .addElement(new ElementEnergyBar(80, 10, (ModuleEnergy) ((TileEnergyCell) t).modules.get(TileEnergyCell.BATTERY)))
        .addElement(new ElementToggleIOButton(152, 60, (TileModular) t, ((TileEnergyCell) t).BATTERY));
  }

  @Override
  public String getName() {
    return TileBase.getTileName(TileEnergyCell.class);
  }
