...
import epicsquid.gadgetry.machines.tile.TileFluidTank;
...
public class GuiFactoryFluidTank implements IGuiFactory {
  ...
  public Gui constructGui(EntityPlayer player, TileEntity tile) {
    ...
    return new GuiModular(new ContainerModular(t).tryAddSlot(0, 80, 42).initPlayerInventory(player.inventory, 0, 0), 176, 166)
        .addElement(new ElementFluidTank(80, 10, ((ModuleFluid) ((TileFluidTank) t).modules.get(TileFluidTank.TANK)).manager.getTankProperties()[0]))
        .addElement(new ElementToggleIOButton(152, 60, (TileModular) t, ((TileFluidTank) t).TANK));
  }

  @Override
  public String getName() {
    return TileBase.getTileName(TileFluidTank.class);
  }
